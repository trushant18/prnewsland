...
@section('content')
    <div class="slim-pageheader">
        ...
        <h6 class="slim-pagetitle">Email Templates</h6>
    </div><!-- slim-pageheader -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <span class="pull-right float-right ml-auto">
                    <a href="{{ route('admin.email_template.create') }}" class="btn btn-success btn-sm"
                       title="Add New">
                ...
                @foreach($email_templates as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" onclick="confirmDelete('{{ route("admin.email_template.delete",$item->id) }}')" class="btn btn-danger btn-sm" title="Delete">
